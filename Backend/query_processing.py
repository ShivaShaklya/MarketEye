...
#Do sanity check and impossible constraint combinations after market research call
...
def get_constraints_from_query(chat):
    prompt = """
    Extract ONLY explicitly stated constraints from the idea.

    Rules:
    - Do NOT infer or guess.
    - Ignore anything implied.
    ...
    user_message=f"""orginal idea: {chat["idea_raw"]}\n idea understanding: {chat["idea_understanding"]}"""
